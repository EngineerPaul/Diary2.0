...
class PeriodicDateSerializer(serializers.Serializer):
    """Сериализатор для отображения следующей даты уведомления в форме"""

    period = serializers.CharField(min_length=7, max_length=9, required=True)
